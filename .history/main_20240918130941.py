...
async def save_addressing_point(ego_location: str, location: str):
    ...
    with open(ego_pose_path, "r") as f:
        ...
        geo_location_x_str = str(geo_location[0]).format(".6f")
        geo_location_y_str = str(geo_location[1]).format(".6f")
        geo_location_z_str = str(geo_location[2]).format(".6f")
        geo_location_str = (
            f"{geo_location_x_str}_{geo_location_y_str}_{geo_location_z_str}"
        )
