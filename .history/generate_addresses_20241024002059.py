...
print(reference_loc)
target_loc = {"lat": 23.59051534400004, "lon": 58.14583060000007, "alt": 48.25}
loc1 = (reference_loc["lat"], reference_loc["lon"])
loc2 = (target_loc["lat"], target_loc["lon"])
loc12_x = (reference_loc["lat"], target_loc["lon"])
loc12_y = (target_loc["lat"], reference_loc["lon"])
x = hs.haversine(loc1, loc12_x, unit=Unit.METERS)
y = hs.haversine(loc1, loc12_y, unit=Unit.METERS)
result = hs.haversine(loc1, loc2, unit=Unit.METERS)
print("The distance calculated is:", result, x, y)
